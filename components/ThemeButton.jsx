...
const ThemeButton = () => {
    return (
        <label className="relative inline-flex items-center cursor-pointer" >
            ...
            <div className="group peer ring-0 bg-[#e3e9f0] rounded-full outline-none duration-300 after:duration-300 w-16 h-[30px]  shadow-md peer-checked:bg-[#3c50e0]  peer-focus:outline-none  after:content-[''] after:rounded-full after:absolute after:bg-gray-50 after:outline-none after:h-5 after:w-5 after:top-1 after:left-1 after:flex after:justify-center after:items-center peer-checked:after:translate-x-9" >
